...
from profile.views.buttons import GetVoice, GetOps, SendMessage, RegenerateToken
from profile.views.delete_profile import DeleteProfile
from profile.views.edit_profile import EditProfile
from profile.views.overview import ProfileView


urlpatterns = patterns(
    '',
    # Pages
    url(r'^/?$', login_required(ProfileView.as_view()), name='profile_overview'),
